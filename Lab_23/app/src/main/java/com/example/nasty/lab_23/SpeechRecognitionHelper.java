//package com.example.nasty.lab_23;
//
...
//
///**
// * Created by nasty on 15.03.2018.
// */
//
...
//     * Если Activity нет, отправляет пользователя в маркет установить Голосовой Поиск Google. Если Activity для распознавания есть, то отправляет Intent для ее запуска.
//     *
